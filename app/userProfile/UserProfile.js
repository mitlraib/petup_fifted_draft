  ...
  return (
    <View>
      ...
      <Text style={styles.name}>{" " + user?.firstName + " "}</Text>
          ...
          <Text style={styles.menuHeader} > ניסיון  </Text>

     
          <Text style={styles.menuHeader} > תיאור </Text>


      
          <Text style={styles.menuHeader} > כתובת מייל </Text>
          
      

          <Pressable onPress={whenLogOutClicked}>
          <Text style={styles.menuHeader} >שלח הודעה</Text>
          </Pressable>
    </View>
  )
};
